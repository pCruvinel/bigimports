...
const ConnectionLogsViewer = () => {
  ...
  const fetchLogs = async () => {
    try {
      ...
      const response = await api.get(`/admin/logs/connections?${params}`);
  ...
  return (
    <div style={{ padding: '20px' }}>
      <h2 style={{ marginBottom: '20px' }}>Logs de Conexão</h2>
            ...
            <table style={tableStyle}>
              <thead>
                <tr style={{ background: '#f8f9fa' }}>
                  ...
                  <th style={tableHeaderStyle}>Status Anterior</th>
                  <th style={tableHeaderStyle}>Novo Status</th>
                  <th style={tableHeaderStyle}>Mensagem</th>
                </tr>
              </thead>
              <tbody>
                {logs.map((log, index) => (
                  <tr key={index} style={{ borderBottom: '1px solid #dee2e6' }}>
                    <td style={tableCellStyle}>{formatDate(log.timestamp)}</td>
                    ...
                    <td style={tableCellStyle}>{log.previous_status || '-'}</td>
                    <td style={tableCellStyle}>{log.new_status || '-'}</td>
